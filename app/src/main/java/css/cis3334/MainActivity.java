                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            API student = new API();
                            student.setName(firstUser.getString("name"));
                            student.setId(String.valueOf(firstUser.getInt("id")));

                            textViewStatus.setText("Student Name: " + student.getName() + "\nStudent ID: " + student.getId());
                        } catch (JSONException e) {
                            e.printStackTrace();
                            textViewStatus.setText("JSON Parsing Error: " + e.getMessage());
                        }
                    }
                },
